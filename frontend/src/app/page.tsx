            ...
            {!isSignedIn ? (
              <>
                <SignInButton mode="modal">
                  <button className="text-sm font-medium text-gray-600 hover:text-gray-900 transition px-4 py-2 rounded-lg hover:bg-gray-50">
                    Đăng nhập
                  </button>
                </SignInButton>
                <SignUpButton mode="modal">
                  <button className="text-sm px-4 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-600 text-white font-semibold transition-all shadow-md shadow-emerald-200">
                    Đăng ký
                  </button>
                </SignUpButton>
              </>
          ...
          <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-2 shadow-lg">
            ...
            <div className="pt-2 flex flex-col gap-2 border-t border-gray-100 mt-2">
              {!isSignedIn ? (
                <>
                  <SignInButton mode="modal">
                    <button onClick={() => setMenuOpen(false)} className="w-full py-2 rounded-lg border border-gray-200 text-sm text-gray-700">Đăng nhập</button>
                  </SignInButton>
                  <SignUpButton mode="modal">
                    <button onClick={() => setMenuOpen(false)} className="w-full py-2 rounded-lg bg-emerald-500 text-white font-semibold text-sm">Đăng ký</button>
                  </SignUpButton>
                </>
              ) : (
